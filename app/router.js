...
module.exports = app => {
  ...
  router.post("/recordIfStuSendMessage", controller.student.student.recordIfStuSendMessage)
  router.post('/teacherAlreadyReadMessage', controller.teacher.teacher.teacherAlreadyReadMessage)
  ...
  router.get("/adminClickStuTitleInfo", controller.admin.admin.adminClickStuTitleInfo)
  router.get('/teacherLookUpPastRecord', controller.teacher.teacher.teacherLookUpPastRecord)
